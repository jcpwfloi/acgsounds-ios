...
class SheetDetailCell: TableViewCell {
    ...
    private func prepareBottomBar() {
        ...
        pdfButton = Button(title: "Open PDF")
...
extension SheetDetailCell {
    ...
    fileprivate func handlePdfButton() {
        ...
        sheetNavigation.pushViewController(readerController, animated: true)
    }
}
